...
public class AlsoMyFormatter implements Formatter {

	private static final String DEFAULT_PRE_TAG = "\033[1m";
	  private static final String DEFAULT_POST_TAG = "\033[0m"; 
	  
	  private String preTag;
	  private String postTag;

	  public AlsoMyFormatter(String preTag, String postTag) {
	    this.preTag = preTag;
	    this.postTag = postTag;
	  }

	  /** Default constructor uses HTML: &lt;B&gt; tags to markup terms. */
	  public AlsoMyFormatter() {
